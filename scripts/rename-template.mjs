...
const performRename = async () => {
  ...
  shell.sed('-i', /custom-conversation-transfer/g, `${name}`, `./infra-as-code/state/import_internal_state.sh`);
  shell.sed('-i', /custom-conversation-transfer/g, `${name}`, `./infra-as-code/terraform/environments/default/variables.tf`);
  ...
  shell.sed('-i', /custom-conversation-transfer/g, `${name}`, `./infra-as-code/terraform/modules/callback-and-voicemail/variables.tf`);
